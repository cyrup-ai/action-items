...
#[allow(dead_code)] // Core TLS function - used by verify_peer_certificate internally
...
#[allow(dead_code)] // Core TLS function - called by tls_config.rs verify methods
...
#[allow(dead_code)] // Core TLS helper function - used by verify_hostname
pub(crate) fn match_hostname(hostname: &str, pattern: &str) -> bool {
    ...
    if pattern.starts_with("*.") {
        let pattern_suffix = pattern.strip_prefix("*.").unwrap(); // Remove "*."
