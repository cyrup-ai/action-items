...
pub fn request_desktop_folder(tx: Sender<Result<PermissionStatus, PermissionError>>) {
    std::thread::spawn(move || {
...
pub fn request_documents_folder(tx: Sender<Result<PermissionStatus, PermissionError>>) {
    std::thread::spawn(move || {
...
pub fn request_downloads_folder(tx: Sender<Result<PermissionStatus, PermissionError>>) {
    std::thread::spawn(move || {
