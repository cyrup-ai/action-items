...
use super::{av_permissions, location_permissions, event_kit_permissions, contacts_permissions, bluetooth_permissions, tcc_permissions};
...
impl PermissionHandler for MacOSHandler {
    ...
    fn request_permission(&self, typ: PermissionType, tx: Sender<Result<PermissionStatus, PermissionError>>) {
        match typ {
...
impl MacOSHandler {
    ...
    pub fn request_accessibility(&self, tx: Sender<Result<PermissionStatus, PermissionError>>) {
        #[cfg(target_os = "macos")]
        {
    ...
    pub fn request_screen_recording(&self, tx: Sender<Result<PermissionStatus, PermissionError>>) {
        #[cfg(target_os = "macos")]
        unsafe {
    ...
    pub fn request_input_monitoring(&self, tx: Sender<Result<PermissionStatus, PermissionError>>) {
        #[cfg(target_os = "macos")]
        {
    ...
    fn request_tcc_permission(&self, typ: PermissionType, tx: Sender<Result<PermissionStatus, PermissionError>>) {
        #[cfg(target_os = "macos")]
        {
