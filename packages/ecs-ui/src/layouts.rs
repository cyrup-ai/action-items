...
/// **Boundary** - Declarative layout type that is defined by its top-left corner and bottom-right
/// corner.
#[derive(Debug, Default, Clone, Copy, PartialEq, Reflect)]
...
impl UiLayoutTypeBoundary {
    ...
    /// Add margin by adjusting both corners inward
    pub fn with_margin(mut self, margin: impl Into<UiValue<Vec2>>) -> Self {
        let margin_vec = margin.into();
        self.pos1 += margin_vec;
        self.pos2 -= margin_vec;
        self
    }
    /// Add border by adjusting both corners  
    pub fn with_border(mut self, border: impl Into<UiValue<Vec2>>) -> Self {
        let border_vec = border.into();
        self.pos1 += border_vec;
        self.pos2 -= border_vec;
        self
    }
    /// Quick padding shorthand
    pub fn padded(self, padding: impl Into<UiValue<Vec2>>) -> Self {
        self.with_margin(padding)
    }
...
impl UiLayoutTypeWindow {
    ...
    /// Centers the layout by setting anchor to center
    pub fn centered(mut self) -> Self {
        self.anchor = Anchor::Center;
        self
    }
    /// Add padding by adjusting position and size
    pub fn with_padding(mut self, padding: impl Into<UiValue<Vec2>>) -> Self {
        let padding_vec = padding.into();
        self.pos += padding_vec;
        self.size -= padding_vec * 2.0;
        self
    }
    /// Add margin by adjusting position
    pub fn with_margin(mut self, margin: impl Into<UiValue<Vec2>>) -> Self {
        self.pos += margin.into();
        self
    }
    /// Adjust size for borders  
    pub fn with_border(mut self, border: impl Into<UiValue<Vec2>>) -> Self {
        let border_vec = border.into();
        self.size -= border_vec * 2.0;
        self
    }
    /// Quick padding shorthand
    pub fn padded(self, padding: impl Into<UiValue<Vec2>>) -> Self {
...
impl UiLayoutTypeSolid {
    ...
    /// Add margin by adjusting size
    pub fn with_margin(mut self, margin: impl Into<UiValue<Vec2>>) -> Self {
        self.size += margin.into();
        self
    }
    /// Adjust size for borders
    pub fn with_border(mut self, border: impl Into<UiValue<Vec2>>) -> Self {
    ...
    pub fn padded(self, margin: impl Into<UiValue<Vec2>>) -> Self {
